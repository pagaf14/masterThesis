...
flowvtu = XMLUnstructuredGridReader(registrationName='flow.vtu', FileName=['/Users/matteopaganelli/Desktop/masterThesis/ADJOINT_TUTORIALS/3_CONSTRAINED_INVISCID_3D_ONERAM6/DESIGNS/DSN_012/DIRECT/flow.vtu'])
...
flowvtuDisplay.ScalarOpacityUnitDistance = 0.365772905117634
...
flowvtuDisplay.ScaleTransferFunction.Points = [0.5795985460281372, 0.0, 0.5, 0.0, 1.3787063360214233, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
flowvtuDisplay.OpacityTransferFunction.Points = [0.5795985460281372, 0.0, 0.5, 0.0, 1.3787063360214233, 1.0, 0.5, 0.0]
...
# export view
ExportView('/Users/matteopaganelli/Desktop/prova.csv', view=spreadSheetView1)
...
renderView1.CameraPosition = [0.0, 5.479043006896973, 59.02190594014343]
renderView1.CameraFocalPoint = [0.0, 5.479043006896973, 0.0]
renderView1.CameraParallelScale = 15.275993335558718
